...
fn run_year(opts: &Opts, year: i32) -> miette::Result<()> {
    ...
    match year {
        2015 => {
            ...
            run_day(y2015::day05::part1, y2015::day05::part2, 5, (true, true), opts.debug)?;
            run_day(y2015::day06::part1, y2015::day06::part2, 6, (true, true), opts.debug)?;
            run_day(y2015::day07::part1, y2015::day07::part2, 7, (true, true), opts.debug)?;
            Ok(())
        }
        2021 => {
        ...
        2022 => {
            ...
            run_day(y2022::day03::part1, y2022::day03::part2, 3, (true, true), opts.debug)?;
            run_day(y2022::day04::part1, y2022::day04::part2, 4, (true, true), opts.debug)?;
        ...
        2023 => {
            ...
            run_day(y2023::day02::part1, y2023::day02::part2, 2, (true, true), opts.debug)?;
            run_day(y2023::day03::part1, y2023::day03::part2, 3, (true, true), opts.debug)?;
            Ok(())
        }
    ...
    match year {
        2015 => {
            match day {
                ...
                2 => run_day(y2015::day02::part1, y2015::day02::part2, 2, parts, opts.debug)?,
                3 => run_day(y2015::day03::part1, y2015::day03::part2, 3, parts, opts.debug)?,
                4 => run_day(y2015::day04::part1, y2015::day04::part2, 4, parts, opts.debug)?,
                5 => run_day(y2015::day05::part1, y2015::day05::part2, 5, parts, opts.debug)?,
                6 => run_day(y2015::day06::part1, y2015::day06::part2, 6, parts, opts.debug)?,
                7 => run_day(y2015::day07::part1, y2015::day07::part2, 7, parts, opts.debug)?,
                _ => {
                    return Err(miette!(
        ...
        2022 => {
            match day {
                ...
                3 => run_day(y2022::day03::part1, y2022::day03::part2, 3, parts, opts.debug)?,
        ...
        2023 => {
            match day {
                ...
                2 => run_day(y2023::day02::part1, y2023::day02::part2, 2, parts, opts.debug)?,
                3 => run_day(y2023::day03::part1, y2023::day03::part2, 3, parts, opts.debug)?,
                _ => {
                    return Err(miette!(
                        "Unable to run: No solution available for year {} day {}.",
                        &year,
